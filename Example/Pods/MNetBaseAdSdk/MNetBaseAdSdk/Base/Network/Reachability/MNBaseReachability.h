...
typedef enum : NSInteger {
    MNBaseNetworkNotReachable = 0,
    MNBaseNetworkReachableViaWiFi,
    MNBaseNetworkReachableViaWWAN
} MNBaseNetworkStatus;

#pragma mark IPv6 Support
// Reachability fully support IPv6.  For full details, see ReadMe.md.

extern NSString *kMNBaseReachabilityChangedNotification;

@interface MNBaseReachability : NSObject
